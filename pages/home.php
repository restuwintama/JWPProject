<div class="w-full bg-stone-900 text-white rounded-3xl overflow-hidden relative text-center shadow-2xl">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-6 py-24">
        ...
        <h1 class="text-4xl md:text-6xl font-black mb-4 tracking-tight leading-tight">
            Petualangan Dimulai <br/><span class="text-emerald-400">dari Sini.</span>
        </h1>
        
        <p class="text-lg text-stone-300 mb-8 leading-relaxed font-medium">
            Arunika Outdoor menyediakan layanan penyewaan dan penjualan alat gunung terlengkap. Kami siap melengkapi perjalanan Anda menuju puncak.
        </p>
        
        <a href="?p=shop" class="bg-amber-500 hover:bg-amber-600 text-stone-900 font-black py-3 px-8 rounded-full text-lg transition-all shadow-[0_0_15px_rgba(245,158,11,0.4)] inline-block">
            Lihat Katalog Alat
        </a>
    </div>
</div>